...
while done:
    ...
    #nhân vật
    if dow == 1 and location > 4:
        nhanvat(down4,changex,changey)
    if location==1 and dow == 1:
        nhanvat(down1,changex,changey)
    if location==2 and dow == 1:
        nhanvat(down2,changex,changey)
    if location==3 and dow == 1:
    ...
    if lefl > 4 and lef == 1:
        lefl = 1
    if right == 1 and rightl > 4:
        nhanvat(right2,changex,changey)
    if rightl == 1 and right ==1:
        nhanvat(right1,changex,changey)
    if rightl == 2 and right ==1:
        nhanvat(right2,changex,changey)
    if rightl == 3 and right ==1:
